...
HD_PWD='D:/Documents/AXI/AXI_Lite/AXIL_VivadoProj/AXIL_VivadoProj.runs/design_1_axi_protocol_checker_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_protocol_checker_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_protocol_checker_0_0.tcl
